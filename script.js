...
const quiz = [
    {
        question: "Q. How can we change the background color of an element?",
        choices: ["background-color", "color", "Both A and B", "None of the above"],
        answer: "background-color"
    },
    {
        question: "Q. What type of CSS is generally recommended for designing large web pages??",
...
const showQuestions = () => {
    ...
    questionBox.textContent = (currentQuestionIndex+1) + questionDetails.question;
